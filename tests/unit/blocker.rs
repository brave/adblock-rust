...
mod blocker_tests {
    ...
    use crate::network_filter_list::{vec_hashmap_len, NetworkFilterList};
    use crate::request::Request;
    use crate::resources::Resource;
    use std::collections::HashSet;
    use std::iter::FromIterator;

    type Blocker = super::super::Blocker<NetworkFilterList>;
