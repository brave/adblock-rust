...
// TODO: types we need to support
// HashMap<String, Vec<String>>
// HashMap<String, Vec<String>> (flat) ?
// HashMap<String, Vec<(String, PermissionMask)>>
// HashMap<u32, Vec<NetworkFilter>>
// HashSet<String>
...
impl<'a, 'b, I, V> Iterator for FlatFilterMapViewIterator<'a, 'b, I, V>
where
  I: Ord + Copy + Follow<'a>,
  V: Follow<'a>,
  I::Inner: Ord,
