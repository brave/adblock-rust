...
impl<'a> From<(&'a Blocker<NetworkFilterList>, &'a CosmeticFilterCache)> for SerializeFormat<'a> {
    fn from(v: (&'a Blocker<NetworkFilterList>, &'a CosmeticFilterCache)) -> Self {
        let (blocker, cfc) = v;
        Self {
            csp: &blocker.csp,
...
impl From<DeserializeFormat> for (Blocker<NetworkFilterList>, CosmeticFilterCache) {
