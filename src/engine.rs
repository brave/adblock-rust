...
pub struct Engine<FilterListType>
where
    FilterListType: NetworkFilterListTrait,
{
...
impl<FilterListType> Default for Engine<FilterListType>
where
    FilterListType: NetworkFilterListTrait,
{
...
impl<FilterListType> Engine<FilterListType>
where
    FilterListType: NetworkFilterListTrait,
{
