...
pub mod network_filter_list {
    ...
    impl<'a> Reader<'a> {
        ...
        #[inline]
        pub fn get_network_filters(
            self,
        ) -> ::capnp::Result<
            ::capnp::struct_list::Reader<'a, crate::network_filter_capnp::network_filter::Owned>,
        > {
            ::capnp::traits::FromPointerReader::get_from_pointer(
                &self.reader.get_pointer_field(0),
                ::core::option::Option::None,
        ...
        #[inline]
        pub fn get_unique_domains_hashes(
            self,
    ...
    impl<'a> Builder<'a> {
        ...
        pub fn get_network_filters(
            ...
            ::capnp::struct_list::Builder<'a, crate::network_filter_capnp::network_filter::Owned>,
        > {
            ::capnp::traits::FromPointerBuilder::get_from_pointer(
                self.builder.get_pointer_field(0),
                ::core::option::Option::None,
        ...
        #[inline]
        pub fn set_network_filters(
            &mut self,
            value: ::capnp::struct_list::Reader<
                '_,
                crate::network_filter_capnp::network_filter::Owned,
            >,
        ) -> ::capnp::Result<()> {
            ::capnp::traits::SetterInput::set_pointer_builder(
                self.builder.reborrow().get_pointer_field(0),
        ...
        #[inline]
        pub fn set_unique_domains_hashes(
            &mut self,
        ...
        #[inline]
        pub fn init_unique_domains_hashes(
            self,
            size: u32,
        ) -> ::capnp::primitive_list::Builder<'a, u64> {
            ::capnp::traits::FromPointerBuilder::init_pointer(
                self.builder.get_pointer_field(1),
                size,
            )
