...
pub fn regions() -> Vec<FilterList> {
    [
        FilterList {
            ...
            title: String::from("ARA: Liste AR"),
        ...
        FilterList {
            ...
            title: String::from("BGR: Bulgarian Adblock list"),
        ...
        FilterList {
            ...
            title: String::from("CHN: EasyList China (中文)"),
        ...
        FilterList {
            ...
            title: String::from("CHN: CJX's Annoyance List"),
            langs: Vec::new(),
        ...
        FilterList {
            ...
            title: String::from("CHN: CJX's EasyList Lite (main focus on Chinese sites)"),
            langs: Vec::new(),
            support_url: String::from("https://github.com/cjx82630/cjxlist"),
        ...
        FilterList {
            ...
            title: String::from("DEU: EasyList Germany"),
        ...
        FilterList {
            ...
            title: String::from("DNK: Schacks Adblock Plus liste"),
        ...
        FilterList {
            ...
            title: String::from("EST: Eesti saitidele kohandatud filter"),
        ...
        FilterList {
            ...
            title: String::from("FIN: Finnish Addition to Easylist"),
        ...
        FilterList {
            ...
            title: String::from("FRA: EasyList Liste FR"),
        ...
        FilterList {
            ...
            title: String::from("GRC: Greek AdBlock Filter"),
        ...
        FilterList {
            ...
            title: String::from("HUN: hufilter"),
        ...
        FilterList {
            ...
            title: String::from("ISL: Icelandic ABP List"),
        ...
        FilterList {
            ...
            title: String::from("ISR: EasyList Hebrew"),
        ...
        FilterList {
            ...
            title: String::from("ITA: ABP X Files"),
            langs: Vec::new(),
        ...
        FilterList {
            ...
            title: String::from("ITA: EasyList Italy"),
        ...
        FilterList {
            ...
            title: String::from("JPN: ABP Japanese filters (日本用フィルタ)"),
        ...
        FilterList {
            ...
            title: String::from("KOR: Fanboy's Korean"),
            langs: Vec::new(),
            support_url: String::from("https://forums.lanik.us/"),
        ...
        FilterList {
            ...
            title: String::from("KOR: Korean Adblock List"),
        ...
        FilterList {
            ...
            title: String::from("KOR: YousList"),
            langs: [String::from("ko")].to_vec(),
        ...
        FilterList {
            ...
            url: String::from("https://margevicius.lt/easylistlithuania.txt"),
            title: String::from("LTU: Adblock Plus Lithuania"),
            langs: [String::from("lt")].to_vec(),
            support_url: String::from("https://margevicius.lt/easylist_lithuania/"),
        ...
        FilterList {
            ...
            title: String::from("LVA: Latvian List"),
        ...
        FilterList {
            ...
            title: String::from("NLD: EasyList Dutch"),
        ...
        FilterList {
            ...
            url: String::from("https://www.certyficate.it/adblock/adblock.txt"),
            title: String::from("POL: polskie filtry do Adblocka i uBlocka"),
        ...
        FilterList {
            ...
            title: String::from("RUS: Adguard Russian Filter"),
            langs: Vec::new(),
        ...
        FilterList {
            ...
            title: String::from("RUS: BitBlock List (Дополнительная подписка фильтров)"),
            langs: Vec::new(),
        ...
        FilterList {
            ...
            title: String::from("RUS: RU AdList (Дополнительная региональная подписка)"),
        ...
        FilterList {
            ...
            title: String::from("SPA: EasyList Spanish"),
        ...
        FilterList {
            ...
            title: String::from("spa, por: Adguard Spanish/Portuguese"),
        ...
        FilterList {
            ...
            title: String::from("SVN: Slovenian List"),
        ...
        FilterList {
            ...
            title: String::from("SWE: Frellwit's Filter List"),
        ...
        FilterList {
            ...
            title: String::from("THA: EasyList Thailand"),
        ...
        FilterList {
            ...
            title: String::from("TUR: Adguard Turkish Filter"),
